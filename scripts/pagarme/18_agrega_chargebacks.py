...
def agregar_chargebacks_pagarme():
    """
    Agrega dados consolidados de chargebacks Pagar.me

    Entrada: PAGAR.ME_CHARGEBACK_CONSOLIDADO.csv
    Saída: PAGAR.ME_CHARGEBACK_AGREGADO.csv
    """
    caminho_arquivo = f"{PATHS['temp']}PAGAR.ME_CHARGEBACK_CONSOLIDADO.csv"
    ...
    colunas_valores = ['Valor Chargeback']
    ...
    output_path = f"{PATHS['temp']}PAGAR.ME_CHARGEBACK_AGREGADO.csv"
...
if __name__ == '__main__':
    print("=== Agregação de Chargebacks Pagar.me ===")
    agregar_chargebacks_pagarme()
    print("Concluído!\n")
