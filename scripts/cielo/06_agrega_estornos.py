...
def agregar_estornos_cielo():
    """
    Agrega dados consolidados de estornos Cielo

    Entrada: CIELO_ESTORNO_CONSOLIDADO.csv
    Saída: CIELO_ESTORNADO_AGREGADO.csv
    """
    caminho_arquivo = f"{PATHS['temp']}CIELO_ESTORNO_CONSOLIDADO.csv"
    ...
    data_agregado = agregar_transacoes(
        df=data,
        coluna_data='Data da solicitação',
    ...
    output_path = f"{PATHS['temp']}CIELO_ESTORNADO_AGREGADO.csv"
...
if __name__ == '__main__':
    print("=== Agregação de Estornos Cielo ===")
    agregar_estornos_cielo()
    print("Concluído!\n")
